...
namespace ERM.Repositorio.Comum.Entity
{
    public class RepositorioGenericoEntity<TEntidade, TChave> : IRepositorioGenerioco<TEntidade, TChave>
        where TEntidade : class
    {
        ...
        public void ExcluirById(TChave id)
        {
